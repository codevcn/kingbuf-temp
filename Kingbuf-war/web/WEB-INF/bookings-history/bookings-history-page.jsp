...
<html lang="vi">
    ...
    <head>
        ...
        <!-- Thêm phần head-libs bằng cách include -->
        <%@ include file="../partials/head-libs.jsp" %>

        <link rel="stylesheet" href="public/bookings-history/bookings-history-page.css" />
    ...
    <body>
        ...
        <script src="public/bookings-history/bookings-history-page.js" defer></script>
    </body>
